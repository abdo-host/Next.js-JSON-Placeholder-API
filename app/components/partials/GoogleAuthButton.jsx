...
export function GoogleAuthButton({loginCallback}) {

    const login = useGoogleLogin({
        onSuccess: codeResponse => loginCallback(codeResponse)
    });

    return (
        <GoogleOAuthProvider clientId="136598943169-ulel207t3dd1jnt7b9etjov6p70qd6n6">
            <Button variant="outlined" color="blue-gray" size="sm" className="flex items-center gap-2" onClick={() => login()}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 186.69 190.5">
